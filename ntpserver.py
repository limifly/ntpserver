...
class NTPPacket:
    ...
    def __init__(self, version=2, mode=3, tx_timestamp=0):
        ...
        self.orig_timestamp1 = 0
        self.orig_timestamp2 = 0
        """originate timestamp"""
        self.recv_timestamp = 0
        """receive timestamp"""
        self.tx_timestamp = tx_timestamp
        self.tx_timestamp1 = 0
        self.tx_timestamp2 = 0
        """tansmit timestamp"""
    ...
    def to_data(self):
        ...
        try:
            packed = struct.pack(NTPPacket._PACKET_FORMAT,
                ...
                self.orig_timestamp1,
                self.orig_timestamp2,
    ...
    def from_data(self, data):
        ...
        self.orig_timestamp1 = unpacked[9]
        self.orig_timestamp2 = unpacked[10]
        self.recv_timestamp = _to_time(unpacked[11], unpacked[12])
        self.tx_timestamp = _to_time(unpacked[13], unpacked[14])
        self.tx_timestamp1 = unpacked[13]
        self.tx_timestamp2 = unpacked[14]
...
##	sendPacket.ref_id = 0x808a8c2c
	...
	sendPacket.orig_timestamp1 = recvPacket.tx_timestamp1
	sendPacket.orig_timestamp2 = recvPacket.tx_timestamp2
